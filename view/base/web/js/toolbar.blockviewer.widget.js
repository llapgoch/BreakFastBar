(function () {
    function init($) {
        ...
        $.widget('llapgoch.breakfastbarblockviewer', {
            _blockTimeout: null,
            _commentBlocks: null,
            overlay: null,
            ...
            _getToolbar: function () {
                return this.element.data('llapgochBreakfastbar');
            },
        ...
        $(document).ready(function () {
            ...
            $('.js-breakfastbar-block-widget').breakfastbarblockviewer();
        });

        return $.llapgoch.breakfastbarblockviewer;
    }
